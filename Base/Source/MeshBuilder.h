...
public:
	...
	static Mesh* MeshBuilder::GeneratePartOfSpriteSheet2D(const std::string &meshName, int width, int height, unsigned numRow, unsigned numCol, int posNumU, int posNumV);
};
